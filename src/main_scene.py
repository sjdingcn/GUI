...
# Form implementation generated from reading ui file '/home/sijie/Desktop/GUI/ui/main_scene.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.push_button_model_setting = QtWidgets.QPushButton(self.tabWidget_2Page1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.push_button_model_setting.sizePolicy().hasHeightForWidth())
        self.push_button_model_setting.setSizePolicy(sizePolicy)
        self.push_button_model_setting.setText("")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../icons/settings-24px.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.push_button_model_setting.setIcon(icon)
        self.push_button_model_setting.setObjectName("push_button_model_setting")
        self.horizontalLayout_6.addWidget(self.push_button_model_setting)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("../icons/add_circle_outline-24px.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.push_button_add_models.setIcon(icon1)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("../icons/remove_circle_outline-24px.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.push_button_remove_models.setIcon(icon2)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("../icons/play_circle_outline-24px.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.push_button_go.setIcon(icon3)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("../icons/save-24px.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_project_save.setIcon(icon4)
        self.action_project_save.setObjectName("action_project_save")
        self.action_project_open = QtWidgets.QAction(MainWindow)
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("../icons/folder_open-24px.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_project_open.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("../icons/zoom_in-24px.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_file_zoom_in.setIcon(icon6)
        self.action_file_zoom_in.setObjectName("action_file_zoom_in")
        self.action_file_zoom_out = QtWidgets.QAction(MainWindow)
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("../icons/zoom_out-24px.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_file_zoom_out.setIcon(icon7)
        self.action_file_zoom_out.setObjectName("action_file_zoom_out")
        self.action_file_default_size = QtWidgets.QAction(MainWindow)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("../icons/fullscreen_exit-24px.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_file_default_size.setIcon(icon8)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("../icons/delete-24px.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_file_delete_polygon.setIcon(icon9)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("../icons/play_arrow-24px.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_train_train.setIcon(icon10)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap("../icons/build-24px.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_train_edit_configurations.setIcon(icon11)
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap("../icons/show_chart-24px.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_analyze_tensorboard.setIcon(icon12)
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap("../icons/add-24px.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_project_new.setIcon(icon13)
        self.action_project_new.setObjectName("action_project_new")
        self.action_inspect_training_data = QtWidgets.QAction(MainWindow)
        self.action_inspect_training_data.setObjectName("action_inspect_training_data")
        self.action_analyze_inspect_trained_model = QtWidgets.QAction(MainWindow)
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap("../icons/insert_chart-24px.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_analyze_inspect_trained_model.setIcon(icon14)
        self.action_analyze_inspect_trained_model.setObjectName("action_analyze_inspect_trained_model")
        self.action_train_inspect_training_data = QtWidgets.QAction(MainWindow)
        self.action_train_inspect_training_data.setIcon(icon14)
        self.action_train_inspect_training_data.setObjectName("action_train_inspect_training_data")
        ...
        self.menuTrain.addAction(self.action_train_inspect_training_data)
        self.menuTrain.addAction(self.action_train_train)
        self.menuAnalyze.addAction(self.action_analyze_tensorboard)
        self.menuAnalyze.addAction(self.action_analyze_inspect_trained_model)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Existing Models: "))
        self.push_button_model_setting.setShortcut(_translate("MainWindow", "Shift+S"))
        ...
        self.push_button_go.setShortcut(_translate("MainWindow", "Shift+G"))
        ...
        self.action_inspect_training_data.setText(_translate("MainWindow", "Inspect Training Data"))
        self.action_analyze_inspect_trained_model.setText(_translate("MainWindow", "Inspect Trained Model"))
        self.action_train_inspect_training_data.setText(_translate("MainWindow", "Inspect Training Data"))
