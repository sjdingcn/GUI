...
class Auto:
    def __init__(self, project_dir, model_dir, weight_name):
    ...
    def detect(self):
        ...
        weights_path = os.path.join(self.model_dir, self.weight_name)

        print("Loading weights ", weights_path)
        model.load_weights(weights_path, by_name=True)
        data = {}
        for root, _, filenames in os.walk(self.label_dir):
