...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.action_project_load.setIcon(icon4)
        self.action_project_load.setObjectName("action_project_load")
        self.action_project_add_images = QtWidgets.QAction(MainWindow)
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("../../resource/add-24px.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_project_add_images.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("../../resource/remove-24px.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_project_remove_images.setIcon(icon6)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("../../resource/zoom_in-24px.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_file_zoom_in.setIcon(icon7)
        self.action_file_zoom_in.setObjectName("action_file_zoom_in")
        self.action_file_zoom_out = QtWidgets.QAction(MainWindow)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("../../resource/zoom_out-24px.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_file_zoom_out.setIcon(icon8)
        self.action_file_zoom_out.setObjectName("action_file_zoom_out")
        self.action_file_default_size = QtWidgets.QAction(MainWindow)
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("../../resource/fullscreen_exit-24px.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_file_default_size.setIcon(icon9)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("../../resource/delete-24px.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_file_delete_polygon.setIcon(icon10)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap("../../resource/play_arrow-24px.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_train_train.setIcon(icon11)
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap("../../resource/build-24px.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_train_edit_configurations.setIcon(icon12)
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap("../../resource/show_chart-24px.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_analyze_tensorboard.setIcon(icon13)
        ...
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap("../../resource/create_new_folder-24px.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_project_new.setIcon(icon14)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.action_project_load.setStatusTip(_translate("MainWindow", "Load an existed project."))
        self.action_project_load.setShortcut(_translate("MainWindow", "Ctrl+L"))
